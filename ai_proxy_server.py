...
COMPONENT_SYSTEM_PROMPT = "\n".join(
    [
        ...
        "custom-interactive 的 js 必须使用 root.querySelector/root.querySelectorAll 查找元素，不要使用 document.querySelector；可以使用 document.createElement；不要请求网络；不要使用 alert；所有交互应在组件内即时反馈。",
